...
public class ExcelReader {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            headerRow.createCell(0).setCellValue("Created Date");
            headerRow.createCell(1).setCellValue("License Code");
            headerRow.createCell(2).setCellValue("Issue Date");
            headerRow.createCell(3).setCellValue("Holder Identity Num");
            headerRow.createCell(4).setCellValue("ID Code");
