...
public class LicenseAppClientToExcelFCZ {
    ...
    private static final String ACCESS_TOKEN = "8a3de44b-264b-4060-8a0a-4d5aa926811b";
    private static final String BASE_URL = "http://172.26.50.55:9090/license-app/v1/license";
    private static final ObjectMapper objectMapper = new ObjectMapper();

    public static void main(String[] args) {
        try {
            List<String> identityNumbers = readIdentityNumbersFromExcel("C:\\Users\\潘强\\Desktop\\identity_numbers_fangchan.xlsx");
            ...
            try (FileOutputStream fileOut = new FileOutputStream("C:\\Users\\潘强\\Desktop\\房产证信息1.xlsx")) {
    ...
    private static List<String> readIdentityNumbersFromExcel(String filePath) throws IOException {
        ...
        try (FileInputStream fileInputStream = new FileInputStream(new File(filePath));
            ...
            for (Row row : sheet) {
                Cell cell = row.getCell(0);  // 读取第一列（身份证号列）
                if (cell != null && cell.getCellType() == CellType.STRING) {
                    String cellValue = cell.getStringCellValue().trim();
                    if (!cellValue.isEmpty()) {
                        identityNumbers.add(cellValue);
                    }
                }
            }
        }
    ...
    private static void extractAndSaveFields(String response, String identityNumber, String authCode, Sheet sheet, int rowNum) throws IOException {
        ...
        try {
            ...
            String zzhm = dataFieldsNode.path("ZZHM").asText("");
